 ...
 *Calcular a média aritmética (variável MD1) desse aluno e apresentar a mensagem "Aprovado" se a média obtida for maior 
 *ou igual a 7; caso contrário, o programa deve solicitar a quinta nota (nota de exame, representada pela variável NE) do
 *aluno e calcular uma novamédia aritmética (variável MD2) entre a nota de exame e a primeira média aritmética (variável MD2) 
 *entre a nota de cinco, apresentar a mensagem ""Aprovado em exame"; caso contrário, apresentar a mensagem "Reprovado". Informar 
